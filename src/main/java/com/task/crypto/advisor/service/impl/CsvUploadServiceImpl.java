...
import com.task.crypto.advisor.exception.UploadCsvException;
import com.task.crypto.advisor.model.CryptoEntry;
import com.task.crypto.advisor.service.CryptoDataService;
import com.task.crypto.advisor.service.CsvUploadService;
import com.task.crypto.advisor.service.CsvValidationService;
...
public class CsvUploadServiceImpl implements CsvUploadService {
    ...
    public UploadResponse uploadCsv(MultipartFile file) {
        ...
        try {
            ...
            filePath = csvPaths + "/" + obtainName(cryptoEntryList) + VALUES_SUFFIX;
